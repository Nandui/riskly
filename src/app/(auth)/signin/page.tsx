  ...
  return (
    <div className="w-full max-w-sm rounded-[var(--radius-card)] border border-line bg-surface p-8 text-center shadow-xs">
      ...
      <p className="mt-1.5 text-sm text-muted">
        Use your LeisureWorld Google account.
      </p>

      {error && (
        <p className="mt-4 rounded-lg border border-critical-line bg-critical-bg px-3 py-2 text-sm font-medium text-critical">
          {error === "AccessDenied"
            ? "That account isn't allowed. Sign in with your @leisureworldcork.com email, or ask an admin for access."
